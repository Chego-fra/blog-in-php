    ...
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          ...
          <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 active load-page" href="./admin/create.php" data-target="main-content">
...
document.addEventListener("DOMContentLoaded", function() {
    document.querySelectorAll(".load-page").forEach(function(link) {
        link.addEventListener("click", function(event) {
            ...
            let target = document.getElementById("main-content"); // Target container

            // Fetch the content
            fetch(url)
                .then(response => response.text())
                .then(html => {
                    target.innerHTML = html; // Insert content
